  ...
  useEffect(() => {
    const fetchGrocery = async () => {
      try {
        ...
        const data = response.data.filter(product => product.category_type === 'grocery');
        setGrocery(data);
      } catch (error) {
  ...
  const generatePDF = () => (
    <Document>
      <Page style={styles.page}>
        <Text style={styles.header}>List of Grocery Products</Text>
  ...
  return (
    <div style={styles.container}>
      <div style={styles.searchContainer}>
        ...
        />
        <Link to='/addProduct' style={styles.addButton}>+ Add New Grocery</Link>
        <PDFDownloadLink document={generatePDF()} fileName="grocery_products.pdf" style={styles.downloadButton}>
      ...
      <table style={styles.table}>
        <thead style={styles.tableHeader}>
          <tr>
            ...
            <th scope="col" style={styles.tableCell}>Grocery Name</th>
          ...
          {grocery && grocery.filter((item) => (
            ...
            <tr key={item._id}>
              ...
              <td style={{ ...styles.tableCell, ...styles.actionButtons }}>
                ...
                <button className="btn btn-danger" onClick={() => groceryDelete(item._id)}>Delete</button>
              </td>
            </tr>
          ))}
        </tbody>
